 ...
 <center><div class="section no-pad-bot" id="index-banner" style="max-width: 50%;">
    ...
    <div class="row">
        <div class="input-field col s12">
          <input name="ID_lenda" id="lenda_id" type="number" class="validate" min="1" required>
      ...
      <div class="row">
        <div class="input-field col s12">
          <input name="semestri" id="semestri" type="number" class="validate" min="1" max="2" required>
